...
> {
    ...
    starStarCabinet = () => {
        ...
        mainStore
            .onStarStarCabinet()
            .then(() => {
                message.success("233333666666");
            })
            .catch(() => {
                message.info("Failed but thank you, maybe you have starred already");
                window.open("https://github.com/surferrer/GStars", "_blank");
            });
    };
    ...
    render() {
        ...
        const mainStore = this.props.store!.main;
        const { selectedRepo, categories, selectRepoCategories } = mainStore;
        ...
        return (
            ...
            >
                ...
                <RepoGroupTool
                    ...
                    repoCategories={selectRepoCategories}
                ...
                <Tooltip placement="bottomRight" title="Star GStar">
